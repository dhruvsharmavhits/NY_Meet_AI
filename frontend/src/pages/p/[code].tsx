...
export default function PatientLinkPage() {
  ...
  const expired = linkInfoError || linkInfo?.expired;
      ...
      <div className="page-gradient relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4">
        ...
        <div className="relative z-10 w-full max-w-[440px] animate-meet-fade-in">
          <div className="glass-card rounded-3xl px-10 py-12 text-center glow-blue">
            ...
            <h1 className="text-2xl font-bold text-[#1a1a2e]">Link expired</h1>
            <p className="mt-2 text-sm text-[#64748b]">This consultation link is no longer valid.</p>
          </div>
        </div>
      </div>
    );
  ...
  if (linkInfo && !linkInfo.room_assigned) {
    return (
      <div className="page-gradient relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4">
        <div className="bg-blob bg-blob-1" />
        <div className="bg-blob bg-blob-2" />
        <div className="relative z-10 w-full max-w-[440px] animate-meet-fade-in">
          <div className="glass-card rounded-3xl px-10 py-12 text-center glow-blue">
            ...
            <h1 className="text-2xl font-bold text-[#1a1a2e]">Hi, {linkInfo.patient_name}</h1>
            <p className="mt-2 text-sm text-[#64748b]">Your consultation room hasn't been set up yet. Please check back soon.</p>
          </div>
        </div>
      </div>
    );
  ...
  if (!identityReady || !user || !linkInfo) {
    return (
