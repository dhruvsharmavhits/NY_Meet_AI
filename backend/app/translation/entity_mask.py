...
_ENTITY_RE = re.compile(f"(?P<URL>{_URL_RE})|(?P<EMAIL>{_EMAIL_RE})|(?P<NUM>{_PHONE_RE})")
_PLACEHOLDER_RE = re.compile(r"\b(EMAIL|URL|NUM)\s*_\s*(\d+)\b")
