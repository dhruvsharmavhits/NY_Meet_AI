...
class Settings(BaseSettings):
    ...
    enable_partial_transcripts: bool = True   # set False to stop live "typing" captions and cut CPU load significantly
    ...
    endpoint_silence_ms: int = 800    # continuous silence required before an utterance is finalized — tolerates
                                       # natural mid-sentence pauses (300-500ms) without cutting the user off.
    partial_interval_ms: int = 900    # how often a live "typing-as-you-speak" partial is regenerated.
